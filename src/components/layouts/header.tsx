...
const Header: React.FC = () => {
    ...
    return (
        <header className='w-full bg-[#060610] h-16 text-white flex flex-col items-center pt-6 gap-y-6 md:px-16 md:py-0 justify-between md:flex-row'>
            ...
            <ul className='flex gap-x-4'>
                <li className='bg-cyan-500 shadow-lg shadow-cyan-500/50 rounded-md px-2 inline-flex items-center'>    
                    <a href="#populares">Populares</a>
                </li>
                <li className='bg-blue-500 shadow-lg shadow-blue-500/50 rounded-md px-2 inline-flex items-center'>
                    <a href="#Novedades">Novedades</a>
                </li>
                <li className='bg-indigo-500 shadow-lg shadow-indigo-500/50 rounded-md px-2 inline-flex items-center'>
